...
{
    public class ImportServiceWithRepo : IImportService
    {
        private readonly IImportedFileRepository _importedFileRepository;
        private readonly ILeadService _leadService;
        private readonly ILogger<ImportServiceWithRepo> _logger;

        public ImportServiceWithRepo(
            IImportedFileRepository importedFileRepository,
            ILeadService leadService,
            ILogger<ImportServiceWithRepo> logger)
        {
