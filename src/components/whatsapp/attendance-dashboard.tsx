          ...
          <div className="flex items-center gap-2 flex-1 min-w-0">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-1 mb-0.5">
                <h4 className="font-medium text-sm text-foreground truncate">{item.talentName}</h4>
                <Badge 
      ...
      <div className="relative overflow-hidden bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border border-green-200 dark:border-green-800 rounded-lg p-2">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2 flex-1 min-w-0">
            ...
            <div className="flex-1 min-w-0">
              <h4 className="font-medium text-sm text-foreground mb-0.5 truncate">{attendance.talentName}</h4>
              <div className="flex items-center gap-2 text-xs text-muted-foreground">
                <div className="flex items-center gap-0.5">
                  <Phone className="h-2.5 w-2.5" />
          ...
          <Button
            ...
            size="sm"
            variant="outline"
            className="ml-2 h-6 px-2 text-red-600 border-red-200 hover:bg-red-50 hover:border-red-300 text-xs"
          >
